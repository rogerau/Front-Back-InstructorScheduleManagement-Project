...
<head>
    ...
    <title> Display all the courses and sections of the table </title>
...
/* Display all the courses and sections of the table 
...
try {
    ...
    $sql= "SELECT CourseId, SectionId FROM Course_Section";  
    ...
    if($row) {
        ...
        echo '<table>';
        echo '<tr> <th>CourseId</th> <th>SectionId</th> </tr>';
        do {
            echo '<tr><td>' . $row['CourseId'] . '</td><td>' . $row['SectionId'] . '</td></tr>';
        }
